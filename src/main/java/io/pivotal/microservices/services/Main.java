 ...
 * 
 * This is based on a modified version of Springs / Paul Chapman's public example at
...
public class Main {
	...
	public static void main(String[] args) {
		...
		} else if (serverName.equals("products")) {		// reo - add products microservice server 
	...
	protected static void usage() {
		...
		System.out.println(
				"     where server-name is 'reg', 'registration', 'accounts', 'products' or 'web' and server-port > 1024"); // reo
	}
}
